...
SITE_URL = "http://www.sindioses.org/"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ((
           ...
           ('/antesdeescribir.html', 'Antes de escribirnos...'),
         ), 'Nosotros'),
        ((
            ('/escepticismo/index.html', 'Escepticismo'),
            ('/cienciaorigenes/index.html', 'Ciencia de los orígenes'),
            ('/sociedad/index.html', 'Sociedad y religión'),
            ('/examenreligiones/index.html', 'Examinando las religiones'),
            ('/simpleateismo/index.html', 'Simplemente ateísmo'),
            ('/colGlenys/index.html', 'La lupa herética'),
            ('/noticias/index.html', 'Noticias de la ciencia'),
            ('/cartas/index.html', 'Cartas de la Edad Media'),
            ('/poesia/index.html', 'Literatura profana'),
            ('/genesis/genesis.html', 'Críticas al Génesis'),
            ('/randi/index.html', 'Traducciones de "Swift" (columna de James Randi)'),
            ('/humor/index.html', 'Humor'),
            ('/frases.html', 'Frases de creyentes'),
            ('/frasesracionalistas.html', 'Frases racionalistas'),
         ), 'Secciones'),
        ((
            ('http://blog-sin-dioses.blogspot.com', 'Blog'),
            ('https://www.facebook.com/SinDioses.org', 'Facebook'),
            ('https://twitter.com/sindioses_org', 'Twitter'),
         ), 'Sociales'),
    ),
}
...
POSTS = (
    ("posts/*.rst", "", "postsd.tmpl"),
    ("posts/*.txt", "", "postsd.tmpl"),
)
PAGES = (
    ("stories/*.rst", "", "postsd.tmpl"),
    ("stories/*.txt", "", "postsd.tmpl"),
)
...
LUXON_DATE_FORMAT = {'es': {'preset': False, 'format': 'yyyy-MM-dd'}}
...
LOGO_URL = '/logos/logotipomenu.png'
...
HIDDEN_CATEGORIES = ['-Ciencia de los Orígenes', 'Hidden']
...
CATEGORY_DESTPATH_NAMES = {
   DEFAULT_LANG: {
       'humor/cerdoateo': 'Humor: El Cerdo Ateo',
       "activismo": "Activismo",
       "anillo": "Anillo escéptico",
       "cartas": "Cartas de la Edad Media",
       "cienciaorigenes": "Ciencia de los orígenes",
       "colGlenys": "La lupa herética",
       "comunidad": "Comunidad Sin Dioses",
       "directorio": "Páginas Sin Dioses",
       "escepticismo": "Escepticismo",
       "examenreligiones": "Examinando las religiones",
       "genesis": "Génesis",
       "humor": "Humor",
       "noticias": "Noticias de la ciencia",
       "palm": "Artículos para dispositivos móviles",
       "poesia": "Literatura profana",
       "randi": "Traducciones de James Randi",
       "simpleateismo": "Simplemente ateísmo",
       "sociedad": "Sociedad y religión",
   },
}
...
# Tag pages will still be generated.
HIDDEN_AUTHORS = ['Guest', 'Sin Dioses']
...
REDIRECTIONS = [
    ('simpleateismo/simpleateismo.html', '/simpleateismo/index.html'),
    ('poesia/poesia.html', '/poesia/index.html'),
    ('libros/librosrecomendados.html', '/libros/index.html'),
    ('sociedad/sociedad.html', '/sociedad/index.html'),
    ('activismo/azules.html', '/examenreligiones/azules.html'),
    ('activismo/peru.html', '/sociedad/peru.html'),
    ('activismo/impuestos.html', '/sociedad/impuestos.html'),
    ('activismo/anexo3.html', '/sociedad/testigos/anexo3.html'),
    ('anillo/anillo.html', '/principal.html'),
    ('anillo/anillosweb.html', '/principal.html'),
...
GALLERY_FOLDERS = {"galleries/cerdoateo": "humor/cerdoateo"}
...
FEED_READ_MORE_LINK = '<p><a href="{link}">{read_more}&hellip;</a></p>'
...
# (translatable)
LICENSE = u"Se permite la reproducción del contenido para fines educacionales y/o científicos siempre y cuando se mencione claramente nuestro sitio web, así como el nombre del autor de cada artículo. Se prohibe su reproducción con fines comerciales."
...
CONTENT_FOOTER = 'Todo el contenido &copy; {date} <a href="mailto:{email}">{author}</a>, salvo que se indique expresamente lo contrario - {license}'
...
CONTENT_FOOTER_FORMATS = {
    DEFAULT_LANG: (
        (),
        {
            "email": BLOG_EMAIL,
            "author": BLOG_AUTHOR,
            "date": "2001-<script>var hoy=new Date(); document.write(hoy.getFullYear())</script><noscript>2100</noscript>",
            "license": LICENSE
        }
    )
}
...
# is in the manual.
COMMENT_SYSTEM_ID = "sitiosindioses"
...
<input type="submit" value="Búsqueda en DuckDuckGo" style="visibility: hidden;" />
</form>
<!-- End of custom search -->
""" % SITE_URL
...
SEARCH_FORM = '''
    ...
    <input type="hidden" name="cx" value="013014139757898556923:udqi_1gk5yk" />   <input type="text" name="q" size="25" />
...
# before </head>
# (translatable)
EXTRA_HEAD_DATA = '<meta name="google-site-verification" content="H-iPswyekGjsVli-A-F7yjJ5CxUpno6BgX227jmH4XA" />'
...
FILE_METADATA_UNSLUGIFY_TITLES = False
...
GLOBAL_CONTEXT = {
    'dictimg': {
        'randi': '/randi/randi2.jpg',
        'lupa': '/quienesGlenys.jpg',
        'noticias': '/quienesGlenys.jpg',
        'afirmacreaidx': '/logos/logo6.gif',
    },
    'addtoany': '''
